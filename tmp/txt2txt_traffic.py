...
def coor2txt(img_w, img_h, coor_data):
    ...
    return f"{str(0)} {str(txt_x)} {str(txt_y)} {str(txt_w)} {str(txt_h)}"
        ...
        with open(os.path.join(panels_info_root, new_txt_name), "w", encoding="utf-8") as panel_in_info:
            ...
            for panel_in_data in panel_in_datas:
                ...
                if get_iou(rect_panel, rect_in_panel) > 0.0:
                    if panel_in_data[0] != "2":
                        continue
                    # panel_in_data[0] = str(new_index[int(panel_in_data[0])])
                    panel_in_data[0] = str(int(panel_in_data[0]))
...
def parse_args():
    ...
    parser.add_argument('--root', type=str,
                        default="/home/fb/project/docker/data/traffic_img/1224", help="root")
    parser.add_argument('--panels_root',
                        type=str, default="/home/fb/project/docker/data/traffic_img/1224_new_val_glass", help="save_root")
    parser.add_argument('--panels_info_root', type=str,
                        default="/home/fb/project/docker/data/traffic_img/1224_new_val_glass_in", help="repeat")
    return parser.parse_args()


if __name__ == '__main__':
    # modify("/home/fb/project/docker/data/traffic_img/1223")
    args = parse_args()
    root = args.root
